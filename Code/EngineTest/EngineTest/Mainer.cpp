...
#pragma endregion
	...
	auto GameManagerScript = resourceManager.addScript_src(Script::getScriptComponentTemplate("GameManager",
		...
		"  if(board:validMove(answer)) then                                                                  \n"
		...
		"  self._board:clear();                                                                              \n"
		"  self.disabled = false;                                                                            \n"
		"  while self._renderables:getSize() do                                                              \n"
		...
		"end                                                                                                 \n"
		"                                                                                                    \n"
		"function GameManager:over()                                                                         \n"
		"  return self.disabled;                                                                             \n"
		"end                                                                                                 \n"
		"                                                                                                    \n"
		"function GameManager:validMove(col)                                                                 \n"
		"  return self._board.validMove(col);                                                                \n"
		"end                                                                                                 \n"
		"                                                                                                    \n"
		"function GameManager:getGamePiece()                                                                 \n"
		"  if(self._unusedRenderables:getSize() == 0) then                                                   \n"
		"    self._unusedRenderables:push(GameManager.Clone(self._connect4Piece));                           \n"
		"  end                                                                                               \n"
		...
		"end                                                                                                 \n"
		"                                                                                                    \n"
		"function GameManager:printBoard()                                                                   \n"
